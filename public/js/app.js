        ...
        <div onclick="abrirDetalleProducto(${p.id})" 
            ...
            <div class="relative z-10 p-3 sm:p-4 flex flex-col justify-between h-full">
                ...
                <div class="relative rounded-xl overflow-hidden mb-3 sm:mb-5 bg-gradient-to-br from-zinc-800/30 to-zinc-900/30 p-2 flex justify-center items-center h-40 sm:h-60">
                    ...
                    <img src="${p.imagen}" class="w-full h-full object-contain relative z-10 group-hover:scale-110 transition-transform duration-500 drop-shadow-[0_8px_24px_rgba(0,0,0,0.5)] [mask-image:radial-gradient(ellipse_at_center,black_70%,transparent_100%)] -webkit-[mask-image:radial-gradient(ellipse_at_center,black_70%,transparent_100%)]" ${p.blend_fondo ? 'style="mix-blend-mode:multiply"' : ''} alt="${p.nombre}" loading="lazy">
                </div>
        ...
        <div class="relative bg-zinc-950 overflow-hidden" style="min-height: ${esMobile ? '280px' : '360px'}; max-height: ${esMobile ? '300px' : '420px'};">
            ...
            <div class="absolute inset-0 flex items-center justify-center z-20 p-6">
                <img id="modal-img-principal" 
                    ...
                    style="max-height: ${esMobile ? '240px' : '320px'}; ${prod.blend_fondo ? 'mix-blend-mode:multiply;' : ''}">
            </div>
            </div>
        ...
        contenedorItems.innerHTML = carrito.map((item, index) => {
            ...
            <div class="flex items-center gap-3 bg-zinc-900 p-3 rounded-xl border border-zinc-800/60 transition-all">
                <div class="w-12 h-12 bg-zinc-950 rounded-lg flex items-center justify-center p-1 flex-shrink-0 border border-zinc-800">
                    <img src="${item.imagen || ''}" class="img-producto h-full object-contain" alt="${item.nombre || 'Vaper'}">
                </div>
